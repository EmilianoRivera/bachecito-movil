...
export default function Registro() {
  ...
  const handleFechaNacimientoChange = (date) => {
    ...
    setDatePickerVisible(false); // Oculta el datepicker
  };
      ...
      .then((userCredential) => {
        ...
        sendEmailVerification(user)
          .then(() => {
            ...
            // Guardar los datos del nuevo usuario en la bd
                  ...
                  onBlur={BirthBlur}
                    ...
                    onChange={(event, selectedDate) => {
                      if (selectedDate !== undefined) {
                        handleFechaNacimientoChange(selectedDate); 
